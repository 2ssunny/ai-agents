...
## 3. **KEEP RECORDING YOUR WORK (DUAL-ARTIFACT SYSTEM)**
   ...
   - Add files generated by this rule in .gitignore file.
   - Store these files in new folder generated in project folder named `log_summary`. If does not exist, generate.
